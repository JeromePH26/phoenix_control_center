...
// GET /api/employees -> backend GET /api/admin/control-center/employees
export async function GET() {
  ...
  try {
    const res = await backendFetch("/employees", { token });
...
// POST /api/employees -> backend POST /api/admin/control-center/employees
