...
// GET /api/model-lab/shadow/performance?modelVersionId= -> backend GET /api/admin/model-lab/shadow-performance?modelVersionId=
export async function GET(req: NextRequest) {
  ...
  try {
    const res = await legacyBackendFetch(`/model-lab/shadow-performance${qs ? `?${qs}` : ""}`);
