...
// POST /api/model-lab/shadow/generate -> backend POST /api/admin/model-lab/shadow-predictions/generate
export async function POST() {
  ...
  try {
    const res = await legacyBackendFetch("/model-lab/shadow-predictions/generate", { method: "POST" });
