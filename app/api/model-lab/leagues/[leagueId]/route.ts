...
// GET /api/model-lab/leagues/[leagueId] -> backend GET /api/admin/model-lab/league/<leagueId>
export async function GET(_req: Request, { params }: { params: { leagueId: string } }) {
  ...
  try {
    const res = await legacyBackendFetch(`/model-lab/league/${encodeURIComponent(params.leagueId)}`);
